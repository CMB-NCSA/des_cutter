...
def write_lightcurve(args):
    ...
    comment = f"# Lightcurve file created by: des-cutter-{desthumbs.__version__} on {date}\n"
...
def write_manifest(args):
    ...
    #change to DES
    comment = f"Manifest file created by: desthumbs-{desthumbs.__version__} on {date}"
    d = args.__dict__
